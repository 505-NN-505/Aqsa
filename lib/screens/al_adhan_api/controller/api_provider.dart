...
class ApiProvider {
  ...
  Future<PrayerTimings> fetchTimings(
      String latitude, String longitude, String calcMethod) async {
    final now = DateTime.now();
    String formatter = DateFormat('dd-mm-yyyy').format(now);
    _date = formatter;

    _url =
        "https://api.aladhan.com/v1/timings/$_date?latitude=$latitude&longitude=$longitude&method=$calcMethod";
